...
CREATE TABLE TIPO_PROYECTO (
    ID_TIPO_PROYECTO SMALLINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE TIPO_INMUEBLE (
    ID_TIPO_INMUEBLE SMALLINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE PARAMETRO_NOMINA(
    ID_PARAMETRO_NOMINA SMALLINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE TIPO_NOVEDAD(
    ID_TIPO_NOVEDAD SMALLINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE TIPO_CONTRATO(
    ID_TIPO_CONTRATO SMALLINT AUTO_INCREMENT PRIMARY KEY,
    DESCRIPCION_TPC VARCHAR(60) NOT NULL,
    ESTADO CHAR(1) NOT NULL DEFAULT 'A'
);

CREATE TABLE PARAMETRO_PRESTACIONES(
    ID_PARAMETRO_PRESTACIONES SMALLINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE EMPLEADO (
    ...
    FOREIGN KEY (ID_PARAMETRO_PRESTACIONES)
        REFERENCES PARAMETRO_PRESTACIONES (ID_PARAMETRO_PRESTACIONES)
);
